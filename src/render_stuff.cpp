...
void drawSpaceShip(SpaceShipObject *spaceShip, const glm::mat4 & viewMatrix, const glm::mat4 & projectionMatrix) {
  ...
  modelMatrix = glm::rotate(modelMatrix, spaceShip->viewAngle, glm::vec3(0, 0, 1));
...
void drawAsteroid(AsteroidObject* asteroid, const glm::mat4 & viewMatrix, const glm::mat4 & projectionMatrix) {
  ...
  modelMatrix = glm::rotate(modelMatrix, float(glm::degrees(angle)), glm::vec3(0, 0, 1));
...
void drawMissile(MissileObject* missile, const glm::mat4 & viewMatrix, const glm::mat4 & projectionMatrix) {
  ...
  float angle = 2.0f*M_PI * frequency * (missile->currentTime-missile->startTime); // angle in radians
  modelMatrix = glm::rotate(modelMatrix, glm::degrees(angle), glm::vec3(0.0f, 0.0f, 1.0f));
