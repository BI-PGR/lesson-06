...
// generates random position that does not collide with tha spaceship
...
void restartGame(void) {
  ...
  gameObjects.spaceShip->viewAngle = 90.0f;
...
void createMissile(glm::vec3 missilePosition, glm::vec3 missileDirection, float &missileLaunchTime) {
